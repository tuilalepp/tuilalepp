...
function firstQuestion(){
    ...
    Swal.fire({
        title: 'Bạn iuu ơi',
        text: 'Mình có điều muốn hỏi bạn ớ :< mà nhớ phải trả lời thật lòng nhaaa.',
...
function textGenerate() {
    var n = "";
    var text = " Tại vì tự nhiên em thấy thích anh quá chời <3 ";
...
$('#yes').click(function() {
    ...
    Swal.fire({
        ...
        cancelButtonText: "Hỏng thèm nói đâu ha",
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonColor: '#fe8a71',
        cancelButtonColor: '#f6cd61',
        confirmButtonText: 'Gửi nè <3'
    }).then((result) => {
        if (result.value) {
            Swal.fire({
                width: 900,
